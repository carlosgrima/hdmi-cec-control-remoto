...
import xbmcaddon
#para poner la fecha en el backup
import time

#from addon import rutaResources
...
def crearVentanaMandos(nombre, titulo, numeroMarca):
	...
	imagen2 = xbmcgui.ControlImage(750, 130, 150, 450, rutaResources + "images_remote_controls/mandoLGOK.png")
