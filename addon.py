...
import shutil #para copiar ficheros
import xbmc #librerias de kodi
import xbmcgui #librerias de gui
import pyxbmct #libreria avanzada de gui que llama a xbmcgui
import time #para coger el tiempo del sistema
import xbmcplugin #para los plugin de kodi
...
import xbmcaddon #para los addon de kodi
